...
extension CurrencyFeedMainPage{
    ...
    func getTweets(){
        CrybseTwitterAPI.shared.getTweets(endpoint: .tweetsSearch, queryItems: ["entity":self.currency,"language":"en","limit":"20","after":self.next_Page_Token as Any]) { data in
