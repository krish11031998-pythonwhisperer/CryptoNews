...
public struct PriceTimeChart: View {
    var header:String
    var data:[Float]
    var size:CGSize
    ...
    public init(header:String,data:[Float] = Array(repeating: Float.random(in: 20..<150), count: 10),size:CGSize = .init(width: totalWidth * 0.9, height: totalHeight * 0.45)){
        self.header = header
        self.data = data
        self.size = size
