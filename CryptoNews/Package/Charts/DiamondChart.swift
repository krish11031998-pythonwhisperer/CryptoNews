...
public struct BaseDiamond:View{
    var size:CGSize
    var color:Color
...
public struct VariableDiamond:View{
    var size:CGSize
    var color:Color
    var points:[Float]
    
    public init(size:CGSize,points:[Float],color:Color = .gray.opacity(0.5)){
        self.size = size
        self.points = points
        self.color = color
    }
...
public struct DiamondAxis:View{
    var size:CGSize
    var color:Color
    
    public init(size:CGSize,color:Color = .gray.opacity(0.5)){
        self.size = size
        self.color = color
    }
...
public struct DiamondChart: View {
    var size:CGSize
    var percent:[String:Float]
    
    public init(size:CGSize = CGSize(width: totalWidth - 20, height: totalWidth - 20),percent:[String:Float]){
        self.size = size
